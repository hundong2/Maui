...
- Repository URL: https://github.com/hundong2/Maui.git
- Checkout SHA: c7019befde8fb4d8c5a2640fe9f7636c5349d0b5
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: .NET MAUI Community Toolkit
- Dependency markers: .NET
- Top-level directories: docs, guide, samples, src
- Category: Systems and runtimes

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for Maui.
...
주 경로는 `Developer / learner -> README and docs -> Setup and deps -> Entry points -> Runtime / systems core -> Binaries / services`이다.
